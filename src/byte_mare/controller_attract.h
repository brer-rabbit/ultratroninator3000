...
#ifndef CONTROLLER_ATTRACT_H
#define CONTROLLER_ATTRACT_H
...
void controller_attract_initialize_control_panel(struct control_panel *control_panel, void *userdata);
